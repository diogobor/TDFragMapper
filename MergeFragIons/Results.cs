...
namespace TDFragMapper
{
    public partial class Results : Form
    {
        ...
        /// </summary>
        private Dictionary<string, (string, string, string, List<(string, int, string, int, string, int, double, string)>, bool, bool)> DictMapsWithoutMergeConditions { get; set; }
        ...
        private void FillListBoxMergeConditions()
        {
            ...
            /// List of All Fragment Ions: FragmentationMethod: UVPD, EThcD, CID, HCD, SID, ECD, ETD; PrecursorChargeState, IonType: A,B,C,X,Y,Z, Aminoacid Position, Activation Level, Replicate, Intensity, MS/MS Data file
            foreach (KeyValuePair<string, (string, string, string, List<(string, int, string, int, string, int, double, string)>, bool, bool)> entry in Core.DictMaps)
            {
        ...
        {
            DictMapsWithoutMergeConditions = new Dictionary<string, (string, string, string, List<(string, int, string, int, string, int, double, string)>, bool, bool)>(Core.DictMaps);
            List<(string, int, string, int, string, int, double, string)> allFragmentIonsAllConditions = new List<(string, int, string, int, string, int, double, string)>();
            ...
            foreach (StringBuilder item in listBoxSelectedMergeConditions.Items)
            {
                ...
                foreach (KeyValuePair<string, (string, string, string, List<(string, int, string, int, string, int, double, string)>, bool, bool)> entry in Core.DictMaps)
                {
                    List<(string, int, string, int, string, int, double, string)> FragmentIons = null;
                    ...
                    if (entry.Value.Item1.StartsWith("Frag"))//First condition is 'Fragmentation Method'
                    {
                        ...
                        List<(string, int, string, int, string, int, double, string)> _tmpFragmentIons = new List<(string, int, string, int, string, int, double, string)>();
            ...
            List<(string, int, string, int, string, int, double, string)> currentNtermFragIons = allFragmentIonsAllConditions.Where(a => a.Item3.Equals("A") || a.Item3.Equals("B") || a.Item3.Equals("C")).ToList();
            List<(string, int, string, int, string, int, double, string)> currentCtermFragIons = allFragmentIonsAllConditions.Where(a => a.Item3.Equals("X") || a.Item3.Equals("Y") || a.Item3.Equals("Z")).ToList();
